...
for (pkg_name in package_names) {
  ...
  print(
    current_data |>
      head(3) |>
      dplyr::mutate(
        across(where(is.character), ~ stringr::str_trunc(., width = 25, ellipsis = "..."))
      ) |> 
      gt::gt() |>
      gt::as_raw_html()
  )
...
[CC-BY](https://github.com/global-health-engineering/`r desc::desc_get_field("Package")`/blob/main/LICENSE.md).
